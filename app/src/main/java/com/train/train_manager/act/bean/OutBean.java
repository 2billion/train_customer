...
//        pickId	int	是		领料单ID
//        pickNo	String	是		领料单号
//        orderId	int	是		订单ID
//        orderNo	String	是		订单号
//        status	int	是		领料单状态：0待下架1下架中2待交接3已完成
//        genTime	String	是		生成时间
//        takeTime	String	否		确认接单时间
//        onOutStockTime	String	否		到达待出库区时间
//        deliveryTime	String	否		交接时间
//        printTime	String	否		打印时间
//        isDelivered	int	否		是否已发货
//        buearuId	int	否		路局ID
//        buearuName	String	否		路局名称
//        orgId	int	否		单位ID
//        orgName	String	否		单位名称
//        wo	String	是		项目号W.O
//        contractNo	String	否		项目号Contract
//        deliveryTo	String	否		发送到
//        reason	String	否		发料原因
//        analyst	String	否		分析员
//        store	String	否		库
