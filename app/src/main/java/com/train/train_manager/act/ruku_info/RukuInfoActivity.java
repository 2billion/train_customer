...
public class RukuInfoActivity extends BaseActivity {

    RefreshLayout refreshLayout;
    ListView list;
    RukuInfoAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ruku_info);
    ...
    public void init() {
        ...
        adapter = new RukuInfoAdapter(this);
    ...
    public void refresh() {
        RukuInfoActivity.this.page = 1;
        getDate();
    }

    public void loadMore() {
        RukuInfoActivity.this.page++;
        getDate();
    }
