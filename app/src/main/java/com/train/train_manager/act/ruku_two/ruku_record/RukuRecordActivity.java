...
public class RukuRecordActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ruku_record_2);
        init();
    }
    ...
    public void init() {
        ...
        searchInput.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                BaseApplication.app.dm.inb_billNo = s.toString();
            }
        });
    ...
    private void getDate() {
        String billNo = BaseApplication.app.dm.inb_billNo;
        String timeStart = BaseApplication.app.dm.inb_timeStart;
        String timeEnd = BaseApplication.app.dm.inb_timeEnd;
        int status = BaseApplication.app.dm.inb_status;


        BaseApplication.app.net.listInB(new NetCallback() {
            @Override
            ...
            @Override
            public void response(Call call, String responseStr) {
        ...
        }, page + "", pageSize + "", billNo, timeStart, timeEnd, status + "");
    ...
    protected void onDestroy() {
        super.onDestroy();
        BaseApplication.app.dm.inb_billNo = "";
    }
